# =============================================================================
# mhl_suite.classicmhl.seal — directory sealing engine
# =============================================================================
# Walks a directory, hashes every non-excluded file, and writes a classic MHL
# manifest. seal() is driven only by the simple-mhl CLI (mhlver never seals), so
# it keeps its operator-facing prints and argument-error sys.exit(2) calls — the
# CLI is a thin pass-through. The hashing controller lives in shared.hashing and is
# reached through the module object so test monkeypatches still intercept it.
# =============================================================================
...
from mhl_suite.shared.hashing import _NULL_TAG, ALGO_MAP, _seal_tag
