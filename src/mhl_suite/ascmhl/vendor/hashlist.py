...
class MHLHashList:
    ...
    creator_info: MHLCreatorInfo | None
    ...
    # log
    def log(self):
        logger.info(f"      filename: {self.get_file_name()}")
        logger.info(f"    generation: {self.generation_number}")
...
class MHLCreatorInfo:
    ...
    def log(self):
        logger.info(f"      host_name: {self.host_name}")
        logger.info(f"           tool: {self.tool.name} {self.tool.version}")
        logger.info(f"  creation_date: {self.creation_date}")
...
class MHLProcessInfo:
    ...
    process: MHLProcess | None
    root_media_hash: MHLMediaHash | None
    ignore_spec: MHLIgnoreSpec
    hashlist_custom_basename: str | None
