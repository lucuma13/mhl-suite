# =============================================================================
# mhl_suite.shared.report — mhlver's report model and renderer
# =============================================================================
# The data model (FileResult / ManifestResult) and the writer for mhlver's
# `--report` log. Kept separate from the terminal-output path so the streaming
# log behaviour isn't affected. Used only by mhlver today; it lives in shared/
# alongside hashing and results as the cross-dialect layer that survives the
# ASC-MHL absorption.
# =============================================================================
