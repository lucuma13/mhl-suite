# =============================================================================
# mhl_suite.shared.hashing — hashing engine and algorithm registry
# =============================================================================
...
# the leaf of the core package — it imports nothing else from mhl_suite.
#
# Cross-module callers (classicmhl.verify, classicmhl.seal) reach these functions through
# the module object (e.g. `from mhl_suite.shared import hashing; hashing.get_hashes`)
# so a test monkeypatching `shared.hashing.get_hashes` / `_probe_read_bw` / the
# calibration helpers still intercepts the call.
# =============================================================================
